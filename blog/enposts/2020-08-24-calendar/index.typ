...
In the third stage, in the *Chongzhen Calendar* of the late Ming and the *Shixian Calendar* introduced at the beginning of the Qing Dynasty, the Lunar Calendar underwent a major upgrade to become what it is today.

= The Modern Lunar Calendar

Reading the *Shixian Calendar* is a bit troublesome. Fortunately, the Purple Mountain Observatory participated in formulating a national standard for the Lunar Calendar in 2017, #link("https://openstd.samr.gov.cn/bzgk/gb/newGbInfo?hcno=E107EA4DE9725EDF819F33C60A44B296", ["Calculation and Promulgation of the Chinese Lunar Calendar (GB/T 33661-2017)"]), which precisely describes how leap months are intercalated.
